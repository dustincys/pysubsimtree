...
def mixture(prefix, config, outfilename):
    ...
    for line in open(config):
        if not line.startswith('#'):
            try:
                ...
                print newline
                filename_1 = prefix + newline[0]+'1.fq'
                filename_2 = prefix + newline[0]+'2.fq'
...
python """
    ...
    if opts.inFile is None:
        ...
        if opts.output is None:
            ...
            out = opts.output
            mixture(opts.prefix, opts.inFile, out)
